...
.. infonote::
    ...
    Детаљни процес добијања овог модела је описан у оквиру материјала за предмет „Базе података“ у трећем разреду гимназије за ученике са посебним способностима за рачунарство и информатику, који се налази на следећој адреси:
...
::
    ...
    INSERT INTO kazne
    VALUES (3, 350, '2019-04-15', 17003, 55, '2019-01-15')
