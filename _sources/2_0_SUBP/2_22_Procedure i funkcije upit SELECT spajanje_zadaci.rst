...
::
    ...
    CREATE PROCEDURE primerci_knjige @naziv_knjige VARCHAR(50)
    AS
...
Како је члан библиотеке дошао да пита за још неку књигу аутора који су написали одређену књигу, има смисла да из резултата искључимо ту књигу, па смо то урадили у последњем реду упита. 
