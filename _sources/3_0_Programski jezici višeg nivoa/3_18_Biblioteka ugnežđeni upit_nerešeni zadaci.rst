...
.. questionnote::
    ...
    1. Приказати презимена запослених, њихове плате и који би износ плате имали након повећања за дати проценат. Приликом тестирања програма нека проценат буде 10. 
...
.. questionnote::
    ...
    3. Приказати презиме, име, имејл адресу и износ плате свих запослених сортирано опадајуће према висини примања. Уколико неколико запослених има исту плату, сортирати их абецедно по презимену и имену. 
...
.. questionnote::
    ...
    9. Приказати запослене који зарађују више од датог износа новца и презиме им почиње на дато слово. Приликом тестирања програма нека износ буде 60.000 динара, а слово П.
...
.. questionnote::
    ...
    16. Приказати уређено абецедно по презимену и имену све запослене који имају менаџера. 

.. questionnote::

    17. Приказати запослене који су почели да раде пре одређеног датума. Приликом тестирања програма нека датум буде 1. јануар 2015. године. 

.. infonote::

    Упити који могу да буду део решења наредне групе задатака се могу пронаћи у лекцији посвећеној спајању табела у упиту SELECT у оквиру материјала за предмет „Базе података“ у трећем разреду гимназије за ученике са посебним способностима за рачунарство и информатику. Лекција се налази на следећој адреси:
...
.. questionnote::
    ...
    8. Приказати назив књиге и име и презиме аутора. Резултат уредити по називу књиге.
...
.. questionnote::
    ...
    6. Приказати за сваког менаџера просечну плату његових запослених. Издвојити само менаџере чији запослени имају просек плата већи од одређеног износа. Приликом тестирања програма нека износ буде 50.000 динара.

.. questionnote::

    7. Приказати за сваког менаџера просечну плату његових запослених. Издвојити само менаџере који имају више од одређеног броја запослених. Приликом тестирања програма издвојити менаџере са више од двоје запослених.
...
.. questionnote::
    ...
    12. Приказати запослене који зарађују исто као запослени са датим презименом. Приликом тестирања програма нека презиме буде Лазовић.
